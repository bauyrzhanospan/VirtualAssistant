...
def train(X, y, hidden_neurons=10, alpha=1, epochs=50000, dropout=False, dropout_percent=0.5):
    ...
    synapse_file = "./FNN/ReasonClassifier/include/synapses.json"
    synapse_file2 = "./FNN/ReasonClassifier/include/synapses" + str(hidden_neurons) + "_" + str(alpha) + ".json"
...
def make_dict():
    d = []
    memes = glob.glob('./FNN/ReasonClassifier/dict/*')
    for meme in memes:
...
# Open needed files
words_file = "./FNN/ReasonClassifier/include/words.json"
with open(words_file) as word_file:
    words = json.load(word_file)
classes_file = "./FNN/ReasonClassifier/include/classes.json"
with open(classes_file) as class_file:
    classes = json.load(class_file)
output_file = "./FNN/ReasonClassifier/include/output.json"
with open(output_file) as out_file:
    output = json.load(out_file)
training_file = "./FNN/ReasonClassifier/include/training.json"
