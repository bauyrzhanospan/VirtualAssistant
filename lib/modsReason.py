...
#Open needed files
words_file = "../ReasonClassifier/include/words.json"
with open(words_file) as word_file:
    words = json.load(word_file)
classes_file = "../ReasonClassifier/include/classes.json"
with open(classes_file) as class_file:
    classes = json.load(class_file)
output_file = "../ReasonClassifier/include/output.json"
with open(output_file) as out_file:
    output = json.load(out_file)
training_file = "../ReasonClassifier/include/training.json"
with open(training_file) as train_file:
    training = json.load(train_file)
    # load our calculated synapse values
synapse_file = '../ReasonClassifier/include/synapses.json'
